...
public class Enemy extends Entity {
    ...
    private float getPhaseSpeed(EnemyPhase phase) {
        ...
        // Phase-2 CHASE cap: when the second phase (index 1, typically
        // "enraged") is chasing, its speed must not exceed half of phase-3's
        // (index 2, typically "desperate") movement speed. Many generated
        // enemies had phase-2 chases at 1.7–1.8 with phase-3 at 2.2–2.4,
        // making the middle phase feel faster than the rage finale. The
        // rule lives in code so we don't have to retune every enemy entry
        // in enemies.json / generated_enemies.json by hand.
        if (phase != null && phase.getMovement() != null
