...
public class ShaderManager {
    ...
    // Stunned: pale blue tint (movement disabled)
    private static final float[] STUNNED = {
        0.3f, 0.4f, 0.7f, 0,
        0.3f, 0.4f, 0.7f, 0,
        0.4f, 0.5f, 0.9f, 0,
        0.05f, 0.1f, 0.2f, 0
    ...
    // Berserk: hot red-orange tint (extra damage)
    private static final float[] BERSERK = {
        1.0f, 0.3f, 0.1f, 0,
        0.8f, 0.2f, 0.05f, 0,
        0.5f, 0.1f, 0.05f, 0,
        0.15f, 0.05f, 0.0f, 0
    ...
    // Damaging: orange aura (deals damage to those nearby)
    private static final float[] DAMAGING = {
        0.95f, 0.55f, 0.1f, 0,
        0.7f, 0.4f, 0.05f, 0,
        0.3f, 0.2f, 0.05f, 0,
        0.1f, 0.05f, 0.0f, 0
    ...
    // Dazed: lavender tint (cannot use abilities)
    private static final float[] DAZED = {
        0.6f, 0.45f, 0.7f, 0,
        0.55f, 0.4f, 0.7f, 0,
        0.6f, 0.5f, 0.85f, 0,
        0.1f, 0.08f, 0.15f, 0
    ...
    public static void applyEffect(SpriteBatch batch, Sprite.EffectEnum effect) {
        ...
        switch (effect) {
            ...
            case STUNNED: matrix = MAT_STUNNED; break;
            case BERSERK: matrix = MAT_BERSERK; break;
            case DAMAGING: matrix = MAT_DAMAGING; break;
            case DAZED: matrix = MAT_DAZED; break;
